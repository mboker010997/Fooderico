def similarity(user, other_user, context):
    tags = []
    if (
        user.preferences_tags is not None
        and other_user.preferences_tags is not None
    ):
    ...
    if (
        user.restrictions_tags is not None
        and other_user.restrictions_tags is not None
    ):
    ...
    if (
        user.interests_tags is not None
        and other_user.interests_tags is not None
    ):
